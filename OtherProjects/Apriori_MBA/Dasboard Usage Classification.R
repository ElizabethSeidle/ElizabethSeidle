...
write.csv(transaction_usage_data, "Transactions_a.csv", 
          row.names = FALSE, quote = FALSE)

tr_individuals <- read.transactions("Transactions_a.csv", 
                                    format = 'basket', sep = ',')
tr_individuals
...
write.csv(transaction_usage_data, "PPM_Transactions.csv", 
          row.names = FALSE, quote = FALSE)

tr_individuals <- read.transactions("PPM_Transactions.csv", 
                                    format = 'basket', sep = ',')
tr_individuals
summary(tr_individuals)
